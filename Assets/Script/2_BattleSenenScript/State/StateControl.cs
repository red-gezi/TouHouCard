...
namespace Control
{
    public class StateControl : MonoBehaviour
    {
        ...
        {
            Info.AllPlayerInfo.Player1Info = new NetInfoModel.PlayerInfo("gezi", "yaya", new List<CardDeck> { new CardDeck("gezi", 0, new List<int> { 1000, 1001, 1000, 1001, 1000, 1001, 1000, 1001, 1000, 1001 }) });
            Info.AllPlayerInfo.Player2Info = new NetInfoModel.PlayerInfo("gezi", "yaya", new List<CardDeck> { new CardDeck("gezi", 0, new List<int> { 1001, 1000, 1001, 1000, 1001, 1000, 1001, 1000, 1001, 1000 }) });
